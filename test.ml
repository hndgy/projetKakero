...
(*	let contains ldata coord = 
	...
	let update datab =
	  let ldata = fst datab and hist = snd datab in
	...
	let connect database nb coord1 coord2  =
	  ...
	  in
	  let newHist = hist@[(coord1,coord2,nb)]
...
let isConnected coord hist =
 ...
 isConnected (7,2) (without ((7, 2), (7, 4), 1) [((2, 2), (2, 0), 2); ((2, 2), (4, 2), 2); ((2, 2), (2, 4), 2);
    ((2, 2), (0, 2), 2); ((0, 0), (2, 0), 2); ((0, 0), (0, 2), 2);
    ((5, 7), (5, 5), 2); ((5, 7), (3, 7), 2); ((8, 0), (8, 3), 1);
    ((8, 0), (5, 0), 1); ((3, 5), (3, 7), 1); ((3, 5), (0, 5), 1);
    ((0, 8), (0, 5), 1); ((0, 8), (2, 8), 1); ((2, 8), (4, 8), 1);
    ((2, 8), (0, 8), 1); ((3, 7), (3, 5), 1); ((3, 7), (1, 7), 1);
    ((5, 0), (8, 0), 1); ((4, 8), (6, 8), 1); ((0, 2), (0, 5), 2);
    ((7, 2), (7, 4), 1); ((4, 2), (4, 4), 2); ((8, 3), (8, 6), 2);
    ((6, 3), (6, 6), 1); ((6, 6), (6, 8), 1); ((8, 6), (8, 8), 1);
    ((6, 8), (8, 8), 1)]);;
...
struct
 ...
 let getCell s (x,y) = List.nth x (List.nth y s)  
...
let strategie2 data_base =
  ...
  let test db = (fst db = []) && (isConnexe db)
  in
...
Solution.print sol;;
   ...
   Data.isConnexe ([], [((2, 2), (2, 0), 2); ((2, 2), (4, 2), 2); ((2, 2), (2, 4), 2);
     ((2, 2), (0, 2), 2); ((0, 0), (2, 0), 2); ((0, 0), (0, 2), 2);
     ((5, 7), (5, 5), 2); ((5, 7), (3, 7), 2); ((8, 0), (8, 3), 1);
     ((8, 0), (5, 0), 1); ((3, 5), (3, 7), 1); ((3, 5), (0, 5), 1);
     ((0, 8), (0, 5), 1); ((0, 8), (2, 8), 1); ((2, 8), (4, 8), 1);
